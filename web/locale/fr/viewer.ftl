...
pdfjs-spread-odd-button =
    .title = Afficher les pages par deux
pdfjs-spread-odd-button-label = Doubles pages
pdfjs-spread-even-button =
    .title = Afficher les pages par trois (expérimental, il peut y avoir des soucis)
pdfjs-spread-even-button-label = Triples pages (expérimental)
#! doubles/triples pages
